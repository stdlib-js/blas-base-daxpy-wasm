...
```javascript
daxpy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-daxpy@v0.0.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-daxpy@v0.0.0-umd/browser.js"></script>
```
